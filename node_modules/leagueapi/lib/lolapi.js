...
(function () {
    ...
    var League = {},
        ...
        championMasteryUrl = 'api.pvp.net/championmastery/location',
        teamUrl = '/v2.4/team/',
    ...
    League.getChampionMastery = function(summonerId, regionOrFunction, callback) {
        var url,
        ...
        return League.getPlatformId(regionAndFunc.region)
            .then(function(platformId) {
				url = util.craftChampionMasteryUrl(championMasteryUrl, regionAndFunc.region, '/' +
                    platformId + '/player/' + summonerId + '/champions?', authKey);

                return util.makeRequest(url, 'Error getting champion mastery: ', null, regionAndFunc.callback);
            })
    };
